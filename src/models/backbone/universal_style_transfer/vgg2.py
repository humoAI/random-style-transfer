...
if __name__ == "__main__":
    ...
    a = load_lua(weight_folder+ 'models/vgg_normalised_conv2_1.t7')
    aInv = load_lua(weight_folder+ 'decoders_noCudnn/feature_invertor_conv2_1.t7')
    ...
    save_pytorch_weights(vgg2, "vgg2")
    save_pytorch_weights(vgg2Inv, "vgg2Inv")