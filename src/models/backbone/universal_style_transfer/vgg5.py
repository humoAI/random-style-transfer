...
if __name__ == "__main__":
    ...
    a = load_lua(weight_folder+ 'models/vgg_normalised_conv5_1.t7')
    aInv = load_lua(weight_folder+ 'decoders_noCudnn/feature_invertor_conv5_1.t7')
    ...
    # print("inverse")
    # print(aInv)
    save_pytorch_weights(vgg2, "vgg5")
    save_pytorch_weights(vgg2Inv, "vgg5Inv")